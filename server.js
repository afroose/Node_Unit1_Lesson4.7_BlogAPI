...
// we're going to add some items to Blog-posts
// so there's some data to look at
BlogPosts.create('Les Trois Mousquetaires', 'Les aventures de d\'Artagnan et ses amis, Athos, Porthos et Aramis', 'Alexandre Dumas', '1857');
